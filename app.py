...
def load_config() -> dict:
    config_path = os.getenv("OPENCLAW_CONFIG_PATH", "config/prod.json")
...
if not account or not region:
    raise ValueError(
        "Account and region are required. Set them in config/prod.json or through CDK_DEFAULT_ACCOUNT/CDK_DEFAULT_REGION."
    )
